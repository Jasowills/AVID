...
required_files=(
  ...
  "docs/decisions/ADR-009-stream-preview.md" "docs/decisions/ADR-010-session-jobs.md"
  "docs/decisions/ADR-011-roughcut-apply.md" "docs/decisions/ADR-012-cloud-auth.md"
