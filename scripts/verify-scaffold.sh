...
required_files=(
  ...
  "apps/desktop/src/components/TopBar.tsx" "apps/desktop/src/components/MediaPanel.tsx" "apps/desktop/src/components/AiPanel.tsx" "apps/desktop/src/pages/Home.tsx"
